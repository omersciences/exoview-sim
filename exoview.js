...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const directives = [
        ...
        },
        {
            ...
            info: "This is Point 2: This part is where there are planets that are closer to Kepler-22b than stars. The most important planet that is close to Kepler-22b in this point is Kepler-186f. This planet is one of the closest Exoplanets to earth as it is only around 557 light years away. From the second point, we can see that there are many close planets to Kepler-22b which makes this planet have many neighbors around it. Lastly there are stars next to some other planets too, an important note is that one these stars is Proxima Centauri which is the one of the closest stars to our Galaxy. " 
        },
        {
            id: 3,
            position: { top: '70%', left: '40%' },
            info: "This is Point 3: This part is about the possible life that people can have on Kepler-22b, and about it's atmosphere. Firstly, it has a thick atmosphere, it may be primarily composed of hydrogen and helium, making it like a mini-Neptune. Also it has a potential for having water which makes it have a chance of habitability as we know it. Lastly this planet can be used as a test planet to use before exploring other planets in our solar system. "
        }
    ];
